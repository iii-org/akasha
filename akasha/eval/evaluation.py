...
class eval(Model_Eval):
    """Generate question sets and evaluate retrieval/model quality."""
    def __init__(
        self,
        ...
        two newline(\n\n). For example, the file should look like: \n
            ...
            Defaults to 4.\n
                **output_file_path (str, optional)**: the path of output question set txt file, if not assign, use doc_path+datetime as the file name.
                Keyword-only options override question format, embeddings, chunking, model, search, token limits, language, logging, and prompt settings for this call.\n
