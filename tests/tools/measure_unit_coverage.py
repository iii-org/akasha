...
def load_test_modules():
    return {
        "test_db_structure": load_module("tests/unit/test_db_structure.py", "test_db_structure"),
        "test_retrievers_base": load_module("tests/unit/test_retrievers_base.py", "test_retrievers_base"),
        "test_helper_base": load_module("tests/unit/test_helper_base.py", "test_helper_base"),
        "test_preprocess": load_module("tests/unit/test_preprocess_prompts.py", "test_preprocess_prompts"),
        "test_search_doc": load_module("tests/unit/test_search_doc.py", "test_search_doc"),
        "test_encoding": load_module("tests/unit/test_encoding.py", "test_encoding"),
        "test_crawler": load_module("tests/unit/test_crawler.py", "test_crawler"),
        "test_agents_core": load_module("tests/unit/test_agents_core.py", "test_agents_core"),
        "test_logging": load_module("tests/unit/test_logging_config_unit.py", "test_logging_config_unit"),
    }
