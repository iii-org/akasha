...
if platform.system() == "Windows":
      sys_dif = ['opencc==1.1.1']
else:
      sys_dif = ['opencc==1.1.6']
...
setup(name='akasha',
      ...
      install_requires = sys_dif.extend( ['pypdf==3.12.2','langchain==0.0.313','chromadb==0.4.14', 'openai==0.27.8',\
                   'tiktoken==0.4.0','lark==1.1.7','scikit-learn<1.3.0','jieba==0.42.1',\
                   'sentence-transformers==2.2.2', 'torch==2.0.1', 'transformers==4.31.0',\
                        'llama-cpp-python==0.2.6','auto-gptq==0.3.1','tqdm==4.65.0', "docx2txt==0.8", "rouge==1.0.1",\
                              "rouge-chinese==1.0.3","bert-score==0.3.13", "click","tokenizers==0.13.3"],
